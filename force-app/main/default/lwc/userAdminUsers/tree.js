 ...
 * @description       : 
<<<<<<< HEAD
 * @author            : mingyoon.woo@partner.dkbmc.com
 * @group             : 
 * @last modified on  : 04-06-2024
 * @last modified by  : yeonji.lim@dkbmc.com
=======
 * @author            : mingyoon.woo@partner.samsung.com
 * @group             : 
 * @last modified on  : 2022-07-22
 * @last modified by  : mingyoon.woo@partner.samsung.com
**/
...
export default function Tree(container, options) {
    const defaultOptions = {
        selectMode: 'hierarchy', // single or hierachy
        select: '',
        selectedNodes: [],
        values: [],
        disables: [],
